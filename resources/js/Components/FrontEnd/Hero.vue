    ...
    <div class="container mx-auto h-full"
        ...
        <div class="flex flex-col md:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start">
                <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Bernard</p>
                    ...
                    <div class="flex items-center mb-6">
                        <a
                            class="
                              ...
                              sm:mr-4
                            "
                            href="https://facebook.com/chisumo"
                        >
                            <svg
                                width="8"
                                height="16"
                ...
                "
                  ...
                  sm:mr-4
                "
                            href="https://linkedin.com/laraveller"
                        >
                            <svg
                                width="14"
                                height="14"
            ...
            <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
                <img  class="rounded-lg" src="http://portfolio-application.test/img/hero.jpeg" alt="Hero">
            </div>
        </div>
    </div>
