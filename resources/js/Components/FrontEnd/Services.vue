    ...
    <section class="section bg-light-secondary dark:bg-dark-secondary">
        <div class="container mx-auto">
            <div class="flex flex-col items-center text-center">
                ...
                <p class="subtitle">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum deleniti dolores eius est exercitationem facere facilis impedit inventore nobis odit provident quam quisquam soluta temporibus, voluptates! Dignissimos eos impedit tempora!
                </p>
            </div>
            <div class="grid lg:grid-cols-4 gap-8">
                ...
                <div class="bg-light-tail-100 dark:bg-dark-navy-500 p-6 rounded-2xl">
                    <div class="text-accent rounded-smm w-12 h-12 flex justify-center items-center mb-24 text-[28px]">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-24 w-24"
                            fill="none"
